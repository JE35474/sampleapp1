		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapbtpsampleapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpsampleapp1-display": {
								"semanticObject": "sapbtpsampleapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.sampleapp1",
									"url": sap.ui.require.toUrl("sap/btp/sampleapp1")
								}
							}
						}
					}
